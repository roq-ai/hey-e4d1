...
function OrganizationListPage() {
  ...
  const { data, error, isLoading, mutate } = useSWR<OrganizationInterface[]>(
    ...
    () =>
      getOrganizations({
        relations: ['user', 'content.count', 'follower.count'],
      }),
  );
            ...
            <Table variant="simple">
              <Thead>
                <Tr>
                  ...
                  {hasAccess('follower', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && <Th>follower</Th>}
                  <Th>Actions</Th>
                </Tr>
              </Thead>
              <Tbody>
